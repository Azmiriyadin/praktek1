...
<head>
    ...
    <title>UAS Desktop Programming</title>
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="icon-grid menu-icon"></i><span class="menu-title">Dashboard</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="icon-grid menu-icon"></i><span class="menu-title">Menu Utama</span></a>
                    </li>
                </ul>
            </nav>
            <div class="main-panel">
                <div class="content-wrapper" id="blokkonten"></div>
                <footer class="footer">
